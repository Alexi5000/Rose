...
class TestSessionManagementE2E:
    ...
    def test_session_persistence_on_refresh(self, page: Page):
        ...
        initial_session = page.evaluate("localStorage.getItem('session_id') || sessionStorage.getItem('session_id')")
        ...
        refreshed_session = page.evaluate("localStorage.getItem('session_id') || sessionStorage.getItem('session_id')")
    ...
    def test_multiple_tabs_different_sessions(self, page: Page, context):
        ...
        session1 = page.evaluate("localStorage.getItem('session_id') || sessionStorage.getItem('session_id')")
        ...
        session2 = page2.evaluate("localStorage.getItem('session_id') || sessionStorage.getItem('session_id')")
