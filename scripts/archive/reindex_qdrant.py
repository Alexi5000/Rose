...
class QdrantReindexer:
    ...
    def __init__(self, batch_size: int = 100, dry_run: bool = False):
        ...
        print("🔄 Initializing Qdrant Reindexer")
    ...
    def check_preconditions(self) -> bool:
        ...
        try:
            ...
            if not collection_exists:
                ...
                return False
            print("✅ Source collection exists")
    ...
    def create_backup(self) -> bool:
        ...
        try:
            ...
            print("⚠️  Note: Qdrant doesn't support direct collection copy")
            ...
            print("   Manual backup recommended: Use Qdrant snapshots or database backup\n")
    ...
    def reindex_points(self) -> bool:
        ...
        try:
            ...
            success_rate = (
                (self.stats["reindexed"] / self.stats["total_points"] * 100) if self.stats["total_points"] > 0 else 0
            )
    ...
    def swap_collections(self) -> bool:
        ...
        try:
            ...
            print("Step 1: Creating backup alias...")
            # Note: Qdrant doesn't have a rename operation
            # We need to delete old and rename temp
            print("⚠️  Warning: Qdrant doesn't support collection rename")
            ...
            print("   Copying points from temp to source...")
            offset = None
            while True:
                records, next_offset = self.client.scroll(
                    collection_name=self.temp_name,
